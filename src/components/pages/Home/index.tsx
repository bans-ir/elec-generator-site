    ...
    return (
        <div className='w-full h-full flex flex-col items-center justify-center relative'>
            <img
                src={BansLogoImage}
                alt='elec home'
                className='h-[40px] w-[130px] bg-black rounded-md text-2xl relative xl:absolute xl:top-2 mb-3'
            />
            <h1 className='text-2xl relative xl:absolute xl:top-24 mb-3'>نرم افزار محاسبه انرژی</h1>
                ...
                >
                    <div className='z-10 rounded-xl w-80 md:w-96 bg-base-100 shadow-sm relative overflow-hidden'>
                        <img
                            ...
                            alt='elec home'
                            className='w-full h-[75px] xl:h-[200px] object-center object-contain p-2 md:p-4 rounded-t-xl mb-2 md:mb-5 group-hover:scale-105 duration-300'
                        />
